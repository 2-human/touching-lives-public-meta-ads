// public/meta-ads/review-mode.js
//
// Adopted 2026-07-01 from glinda/public/method/review-mode.js (glinda
// re-emitted 2026-05-12 in the prota-alignment pass; see glinda's own
// composition manifest for full history). This is a cross-project
// adoption — glinda's mature composed output copied over verbatim except
// for the config-global rename from GLINDA_CONTACT_CONFIG to
// TOUCHING_LIVES_CONTACT_CONFIG. Glinda's structural variations (banner
// <a> not <button>, single center-bottom toast, no modal header close,
// 6px button radius, 9px 18px padding, faster spotlight motion) are
// inherited as-is.
//
// Variation recorded at .composition-manifest.md alongside this file.
//
...
// (per anchor-extensibility.md) — for touching-lives, see contact-form.config.js
// (label, blockquote, cite, figcaption, button for ad-preview surfaces).
const ANCHOR_TAGS = [
  'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
  'p', 'li', 'td', 'th', 'dt', 'dd',
...
// (nav/header/footer) is anchored, not skipped, when chromeAnchored is true.
...
// (default 'allowlist', touching-lives runs 'direct-text'); chrome routing
// gated by state.chromeAnchored. Full contract:
